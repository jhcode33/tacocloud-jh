...
@ComponentScan(basePackages = "tacos.restclient")
@Slf4j
...
//      log.info("AFTER-3:  " + shrimpAfter);
    ...
    public CommandLineRunner traversonSaveIngredient(TacoCloudClient tacoCloudClient) {
        return args -> {
            Ingredient savePico = new Ingredient("PICO", "Pico deGallo", Ingredient.Type.SAUCE);
            //Ingredient pico = tacoCloudClient.addIngredient(savePico);
            ...
            tacoCloudClient.deleteIngredient(savePico);
        };
    }
